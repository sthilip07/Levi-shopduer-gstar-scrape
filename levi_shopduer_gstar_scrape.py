...
class WebScraper:
    ...
    def fetch_shopduder_data(self):
        ...
        return pd.DataFrame(shopduder_data, columns=['Product Url', 'Product Name', 'Product Overview', 'How it Fits', 'Composition & Care', 'Image URL'])
    ...
    def fetch_product_details(self, url):
        ...
        return [url, product_name, product_overview, fit, fabric_and_care, img_url]
    ...
    def create_excel(self):
        ...
        with pd.ExcelWriter('/Users/thilip/Downloads/product_details.xlsx') as writer:
